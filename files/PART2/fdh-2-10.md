...
<!--(This part needs to be made more coherent in respect of the definition of Pivot point at various other places in the Textbook, see also synthesis in 3-1)-->

> Definition: Point
>
> A Point is the intersection of at least two lines.

As soon as the point exist in different spaces, a pivot point can be defined. 
...
Points are defined as the intersection of at least two lines. A point can have a unique id and corresponding coordinates on documents and geometries, and link with other points. 
