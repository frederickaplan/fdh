...
# Anatomy of a large-scale Digital Humanities project
...
This chapter illustrates the various notions developed in the previous chapter with an integrated example, the development of the Venice Time Machine and its extension to Europe. 

## Chronology of the Venice Time Machine

The Venice Time Machine 's' bootstrapping phase was developed between 2012 and 2019. The project is now in its second phase of development, planning activities from 2020 to 2028.
...
The key startegy of Time Machine Europe is to develop a governance by on nurturing collectively Data commons. It is described in a collective writen document presenting a 10y strategy for Europe. The content of the following section is based on this document. 
